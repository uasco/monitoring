...
async function getRainTotalOfmonth(client_id, sensor_id_rain_total,date,returnValue,x) {
    return new Promise(function (resolve, reject) {
        pool.query(sql_query_rain_total_of_end_of_month, [client_id, sensor_id_rain_total , date[1]], function (error, rows, fields) {
        if (error) {
...
module.exports = {
    ...
    getRainTotalsOfPastMonths: async function(client_id, sensor_id_rain_total) {
                ...
                for (var i = 0; i < end_of_months.length; i++) {
                    var arr_item = new Array(jm, end_of_months[jm]);
