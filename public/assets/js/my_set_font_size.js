function myFunction(x) {
    ...
    if (x.matches) { // If media query matches
        ...
        $('[class="title"]').css('z-index', '21').css('text-align', 'center').css('font-size', '3.8vw').css('position', 'relative').css('top', '-3.5vh').css('left', '0.8vh').css('color', 'red').css('height', '8px').css('font-family', defaultFont);
        ...
        $('[class="title"]').css('z-index', '21').css('text-align', 'center').css('font-size', '1.8vw').css('position', 'relative').css('top', '-6.5vh').css('left', '8.5vh').css('color', 'red').css('height', '0px').css('font-family', defaultFont);
        elms = document.querySelectorAll("#date_of_last_recieved_data_label")
        elms.forEach(elm => {
